  ...
  recipes = <Recipe>[
    Recipe(
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-affogato.jpg")),
    Recipe(
        name: "Batido de cafe",
        description:
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-batido.jpg")),
    Recipe(
        name: "Crema de cafe",
        description:
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-crema.jpg")),
    Recipe(
        name: "Frapuccino",
        description:
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-frapuccino.png")),
    Recipe(
        name: "Postre de cafe",
        description:
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-postre-cafe.jpg")),
    Recipe(
        name: "Tiramisu",
        description:
        ...
        photo: AssetFile(
            ...
            assetBundle,
            "assets/images/platillos/cafe-tiramisu.jpg")),
    Recipe(
        name: "Cefe vietnamita",
        description:
            "La sopa de tortillas es uno de los platos favoritos de los salvadoreños por ser relativamente fácil a la hora de preparar, rinde lo suficiente y es ideal para compartir con gran parte de la familia, los ingredientes son accesibles  y es súper deliciosa.",
        date: DateTime.now(),
        id: 7,
        ...
        user: users[9],
        photo: AssetFile(
            assetBundle, "assets/images/platillos/cafe-vietnamita.jpg")),
  ];
}
